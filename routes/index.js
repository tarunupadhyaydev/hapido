...
const {validateUser,validateLogin,validateCompany,validateConnections,validateConnectionStatus,validateAddUserToCompany}=require("../controller/validatore")
...
app.get('/users/search', verifyToken, Users.UserSearch);
